...
var validator = (function($){
    ...
    */
    message = {
        invalid         : 'Valor inv&aacute;lido.',
        checked         : 'Este campo debe ser chequeado.',
        empty           : 'Campo vac&iacute;o. Ingrese valor.',
        min             : 'Valor ingresado es muy corto.',
        max             : 'Valor ingresado es muy largo.',
        number_min      : 'Valor ingresado es muy bajo.',
        number_max      : 'Valor ingresado es muy alto.',
        url             : 'URL inv&aacute;lida.',
        number          : 'Valor debe ser un n&uacute;mero.',
        email           : 'Se espera formato de e-mail.',
        email_repeat    : 'Los e-mails no coinciden.',
        password_repeat : 'Los passwords no coinciden.',
        repeat          : 'No coinciden valores.',
        complete        : 'La entrada no est&aacute; completa.',
        select          : 'Seleccione una opci&oacute;n.'
    };
